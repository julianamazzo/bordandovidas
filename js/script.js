...
botaoMenuHamburguer.addEventListener('click', function(){
	document.querySelector(".ladoEsquerdo.linha.espacoEntre.alinharVertical").classList.toggle('ativo');
	// document.querySelector(".ladoEsquerdo.linha.espacoEntre.alinharVertical").classList.remove('ativo');
})


// ladoEsquerdo linha espacoEntre alinharVertical